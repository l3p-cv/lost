...
export const PIPELINE_RUNNING_GET_PIPELINES_STATUS =
    'PIPELINE_RUNNING_GET_PIPELINES_STATUS'
...
export const PIPELINE_RUNNING_UPDATE_ARGUMENTS_REQUEST_STATUS =
    'PIPELINE_RUNNING_UPDATE_ARGUMENTS_REQUEST_STATUS'
