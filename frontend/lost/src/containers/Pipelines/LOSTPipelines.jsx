        ...
        <Row>
            <Col xs="12" sm="6" lg="6">
                <Card
                    ...
                    style={{ backgroundImage: `url(${vanStripes})` }}
                >
                    <CardBody className="pb-0 " style={{ height: '175px' }}>
                        <div style={{ fontSize: '2em' }}>Single Image Annotation</div>
                        <div
                            style={{
                                alignItems: 'center',
                                display: 'flex',
            ...
            <Col xs="12" sm="6" lg="6">
                <Card
                    className="text-white"
                    style={{ backgroundImage: `url(${proSquares})` }}
                >
                    <CardBody className="pb-0 " style={{ height: '175px' }}>
                        <div style={{ fontSize: '2em' }}>Multi Image Annotation</div>
                        <div
                            style={{
                                alignItems: 'center',
                                display: 'flex',
