...
import * as datasetApi from '../../api/dataset_api'
...
const DatasetEditModal = ({
  ...
  const convertDatasetListToDropdownOptions = (flatDatasetList: Map<number, string>) => {
  ...
  const showApiResponse = (
    ...
    if (isSuccessful === true) {
      ...
      showError(`${errorMessage}: Error ${msgErrorVerb} dataset`, NOTIFICATION_TIMEOUT_MS)
    }
  }
