...
export const useJoyrideSteps = (
  ...
  if (templateType === 'instructionTour' && latestPipelineId== undefined) {
    const instructionTourSteps: Step[] = [
      ...
      },
      {
        ...
        content: 'Click to browse and select images to include in your instructions.',
        placement: 'right',
        spotlightClicks: true,
      },
      {
      ...
      },
      {
        ...
        content: 'Your newly created instruction will appear at the end of this list.Click this "Next" button to Proceed.',
        placement: 'top',
        spotlightClicks: true,
      },
      {
      ...
      },
      {
        ...
        content: 'Here you can edit the instruction details. Make changes and save when done.',
        placement: 'top',
        disableBeacon: true,
        spotlightClicks: true,
      },
      ...
      },
      {
        ...
        content: 'Click here to navigate to the Pipeline Templates page to start an SIA pipeline.',
        placement: 'right',
        disableBeacon: true,
        spotlightClicks: false,
      },
      ...
      },
      {
        ...
        content: 'Select the instructions you created earlier to guide annotators. These instructions, including text and images, ensure annotators understand the task requirements clearly.',
        placement: 'right',
        spotlightClicks: true,
        disableBeacon: true,
      },
      ...
      },
      {
        ...
        content: 'Here you can "View" and "Edit" the instruction options. Make changes and "Save" when done.',
        placement: 'top',
        spotlightClicks: true,
        disableBeacon: true,
      },
  ...
  if(templateType === 'labelTour'){
      ...
      },
      {
        ...
        title: 'Label Created',
        content: 'You have added the first label successfully.\nClick on New Label to Rename',
        placement: 'top',
        disableBeacon: true,
        spotlightClicks: true,
      },
      ...
      content: 'You have added the second label successfully. Click on the label to rename.',
      placement: 'top',
      disableBeacon: true,
      spotlightClicks: true,
    },
    ...
    },
    {
      ...
      content: 'You have added the third label successfully. Click on the label to rename.',
      placement: 'top',
      disableBeacon: true,
      spotlightClicks: true,
    },
