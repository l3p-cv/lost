...
export default {
	enableBBoxCreation, disableBBoxCreation,
	enablePointCreation, disablePointCreation,
	enableLineCreation, disableLineCreation,
	enablePolygonCreation, disablePolygonCreation,
}