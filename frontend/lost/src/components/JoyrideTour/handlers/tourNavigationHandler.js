export const handleNavigationAndActions = (
  index,
  pipelineType,
  latestPipelineId,
  siaPipelineId,
  ...
  if (pipelineType === 'instructionTour' && latestPipelineId == undefined) {
    return handleInstructionTourNavigation(
      index,
      navigate,
      siaPipelineId,
      latestPipelineId,
    ...
    return handlePipelineTourNavigation(
      index,
      pipelineType,
      navigate,
      miaPipelineId,
...
const handleInstructionTourNavigation = (
  index,
  navigate,
  siaPipelineId,
  latestPipelineId,
...
const handlePipelineTourNavigation = (
  index,
  pipelineType,
  navigate,
  miaPipelineId,
...
const handleInstructionTourWithPipelineNavigation = (
  index,
  navigate,
  latestPipelineId,
) => {
