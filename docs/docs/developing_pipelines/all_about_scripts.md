...
[lost/backend/lost/pyapi/examples/pipes](https://github.com/l3p-cv/lost/tree/master/backend/lost/pyapi/examples/pipes)
...
pipeline visualization. In this way you get a first hint what\'s wrong.
