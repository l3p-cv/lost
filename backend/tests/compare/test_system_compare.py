"""Golden-snapshot comparison tests for the system namespace."""
...
from tests.compare.system_specs import get_active_system_specs, RouteSpec


def _run_system_spec(client, auth_headers, spec: RouteSpec, record: bool):
    req = spec.request
...
_ACTIVE_SPECS = get_active_system_specs()
...
def test_system_route(client, auth_headers, record, spec: RouteSpec):
    _run_system_spec(client, auth_headers, spec, record=record)
