...
if __name__ == "__main__":
    ...
    parser.add_argument("packed_pipe", help="Pack pipeline file")
    parser.add_argument("--overwrite", default=False, action="store_true", help="Overwrite pipe if already existing")
