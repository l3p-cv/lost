...
if __name__ == "__main__":
    ...
    parser.add_argument("pipe_dir", help="Path directory with pipeline definition files.")
    parser.add_argument(
        "--copy", default=False, action="store_true", help="Copy to default pipe location before import"
    )
