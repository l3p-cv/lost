...
class DataExport(Element):
    ...
    def to_dict(self):
        ...
        d_list = []
        for export in self.data_exports:
            d_list.append({"iteration": export.iteration, "file_path": export.file_path})
        return d_list
...
class VisualOutput(Element):
    ...
    def to_dict(self):
        ...
        d_list = []
        for v_out in self.v_outs:
            d_list.append({"iteration": v_out.iteration, "img_path": v_out.img_path, "html_string": v_out.html_string})
        return d_list
