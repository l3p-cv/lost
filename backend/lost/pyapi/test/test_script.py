...
REF_BBOXES = [[0.1, 0.1, 0.2, 0.2], [0.2, 0.2, 0.3, 0.15], [0.3, 0.3, 0.3, 0.15]]
...
class TestScriptApi:
    def test_request_annos(self, script_element, tree, local_fs):
        ...
        s.outp.request_annos(
            IMG_PATH2, img_labels=[lbl_vec[2]], annos=[REF_BBOXES[0]], anno_types=["bbox"], anno_labels=[[lbl_vec[2]]]
        )
        df = s.outp.to_df()
