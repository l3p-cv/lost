...
update_label_parser.add_argument("id", type=int, required=True, help="Label Leaf id.")
update_label_parser.add_argument("name", type=str, required=True, help="Label Leaf name")

update_label_parser.add_argument("description", type=str, required=True, help="Label Leaf Description.")
...
create_label_parser.add_argument(
    "is_root", type=bool, required=True, help="Weather this Label is the beginning of a Label Tree."
)
create_label_parser.add_argument("parent_leaf_id", type=int, help="Label Leaf id of the parent Leaf.")
create_label_parser.add_argument("name", type=str, required=True, help="Label Leaf name")

create_label_parser.add_argument("description", type=str, required=True, help="Label Leaf Description.")
