...
get_pipelines_parser.add_argument("pageSize", type=int, help="Page Size", location="args", dest="page_size")
get_pipelines_parser.add_argument("page", type=int, help="Loaded Page", location="args", dest="page")
