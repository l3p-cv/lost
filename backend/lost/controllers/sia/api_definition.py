...
from lost.controllers.api import api
...
image = api.model(
    "Image",
    {
        ...
        "isFirst": fields.Boolean(
            readOnly=True, description="Weather the image is the first one of the annotation process."
        ),
        "isLast": fields.Boolean(
            readOnly=True, description="Weather the image is the last one of the annotation process."
        ),
        "isLast": fields.Boolean(
            readOnly=True, description="Weather the image is the last one of the annotation process."
        ),
        "labelIds": fields.List(
            fields.Integer(readOnly=True, description="Label id."),
        ...
        "imgActions": fields.List(
            fields.String(readOnly=True, description="imgAction"),
            description="Image actions that have been performed by user",
        ),
    },
)
...
bbox = api.model(
    "BBox",
    {
        ...
        "labelIds": fields.List(
            fields.Integer(readOnly=True, description="Label id."),
            description="All label ids which belongs to that bbox.",
        ),
...
point = api.model(
    "Point",
    {
        ...
        "labelIds": fields.List(
            fields.Integer(readOnly=True, description="Label id."),
            description="All label ids which belongs to that point.",
        ),
...
line = api.model(
    "Line",
    {
        ...
        "labelIds": fields.List(
            fields.Integer(readOnly=True, description="Label id."),
            description="All label ids which belongs to that line.",
        ),
...
polygon = api.model(
    "Polygon",
    {
        ...
        "labelIds": fields.List(
            fields.Integer(readOnly=True, description="Label id."),
            description="All label ids which belongs to that polygon.",
        ),
...
sia_config_annos_actions = api.model(
    "SIA Config Anno Actions",
    {
        "draw": fields.Boolean(
            readOnly=True, description="Indicates if an annotator is allowed to draw new 2d annotations."
        ),
        "label": fields.Boolean(
            readOnly=True, description="Indicates if an annotator may assign a label to a 2d annotation."
        ),
        "edit": fields.Boolean(readOnly=True, description="An annotator may edit a 2d annotation in size or shape."),
    },
)
sia_config_annos = api.model(
    "SIA Config Annos",
    {
...
sia_inference_model_config = api.model(
    "SIA Inference Model Config",
    {
...
sia_update_bbox = api.model(
    "SIA update bbox",
    {
        "id": fields.Integer(description="The identifier of the bbox"),
        "labelIds": fields.List(
            fields.Integer(required=True, description="Label id."),
            description="All label ids which belongs to that bbox.",
        ),
        "status": fields.String(
            required=True, description='Status of that bbox can be "new", "changed" and "deleted".'
        ),
...
sia_update_point = api.model(
    "SIA update point",
    {
        ...
        "status": fields.String(
            required=True, description='Status of that point can be "new", "changed" and "deleted".'
        ),
        "data": fields.Nested(
            point_data,
            required=True,
...
sia_update_line = api.model(
    "SIA update line",
    {
        ...
        "status": fields.String(
            required=True, description='Status of that line can be "new", "changed" and "deleted".'
        ),
        "data": fields.List(
            fields.Nested(point_data),
            required=True,
        ),
        "annoTime": fields.Float(readOnly=True, description="Annotation time in seconds"),
        "isExample": fields.Boolean(description="Indicates wether annotation is an example", required=True),
...
sia_update_polygon = api.model(
    "SIA update polygon",
    {
        ...
        "status": fields.String(
            required=True, description='Status of that polygon can be "new", "changed" and "deleted".'
        ),
...
sia_update_annotations = api.model(
    "SIA update annotations",
    {
...
sia_update = api.model(
    "SIA Update",
    {
        "imgId": fields.Integer(required=True, description="Id of image annotation."),
        "annotations": fields.Nested(
            sia_update_annotations, required=True, description="All annotations which should be updated."
        ),
        "imgLabelIds": fields.List(fields.Integer(description="A list of label ids for the image"), required=True),
        "imgLabelChanged": fields.Boolean(
            description="Indicates of the labels for the image have been changed by the annotator", required=True
        ),
        "isJunk": fields.Boolean(
            description="Indicates wether the image was marked as Junk by the annotator.", required=True
        ),
...
labels = api.model("Labels", {"labels": fields.List(fields.Nested(label_leaf))})


sia_polygon_union = api.model(
    "SIA Polygon Union",
    {
...
sia_polygon_intersection = api.model(
    "SIA Polygon Intersection",
    {
        "annotations": fields.List(
            fields.Raw(required=True, description='Each annotation: {"type": "polygon|bbox", "data": [...] or {...}}'),
...
sia_polygon_difference = api.model(
    "SIA Polygon Difference",
    {
        "selectedPolygon": fields.Raw(
            required=True, description='Selected annotation: {"type": "polygon|bbox", "data": [...] or {...}}'
        ),
...
sia_polygon_operations_response = api.model(
    "SIA Polygon Operations Response",
    {
        "type": fields.String(required=True, description="Result type: polygon or bbox"),
        "resultantPolygon": fields.List(
            fields.Nested(point_data), description="Coordinates of the resulting polygon", required=True
        ),
    },
)
        ...
        "filters": fields.List(
            fields.Nested(
                api.model(
                    ...
                    {
                        "name": fields.String(
                            required=True, description="Name of the filter (e.g., cannyEdge, clahe, bilateral)"
                        ),
                        "configuration": fields.Raw(
                            description='Filter-specific configuration (e.g., {"lowerThreshold": 100, "upperThreshold": 200} for cannyEdge, {"clipLimit": 2.0} for clahe) and {"diameter": 9, "sigmaColor": 75, "sigmaSpace": 75} for bilateral'
                        ),
                    },
                )
            ),
...
sia_bbox_from_points = api.model(
    "SIA BBox From Points",
    {
        "data": fields.List(
...
sia_bbox_from_points_response = api.model(
    "SIA BBox From Points Response",
    {
        "data": fields.Nested(
            api.model(
                "BBox Data Response",
