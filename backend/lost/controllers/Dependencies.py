...
def get_annotasks_coordination(dbm: DBMan = Depends(get_db)) -> AnnotasksCoordination:
    """Wire the annotasks coordination service with its collaborators."""
    return AnnotasksCoordination(AnnotasksBusiness(dbm))
